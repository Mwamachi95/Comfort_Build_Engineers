        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <a 
                    ...
                    className="text-sm text-neutral-800 hover:text-primary-red transition-colors duration-200"
                  >
                    {contactInfo.phone}
                  </a>
              ...
              <div className="flex items-start space-x-3">
                <EnvelopeIcon className="h-5 w-5 text-primary-red mt-0.5 flex-shrink-0" />
                <div>
                  <a 
              ...
              <div className="flex items-start space-x-3">
                <MapPinIcon className="h-5 w-5 text-primary-red mt-0.5 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start space-x-3">
                <ClockIcon className="h-5 w-5 text-primary-red mt-0.5 flex-shrink-0" />
                <div>
